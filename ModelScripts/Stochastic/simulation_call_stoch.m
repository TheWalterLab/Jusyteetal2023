...
for l = 1:num_calc
    ...
    parfor z = 1:num_sim
        ...
        [peak1, peak2, time_vector, stoch_EPSC, ppr, peaksum, ttp1,  peak2_extr, ppr_extr, pVr1, stoch_time, ~, ~, ~, ~, ~, peaksum_extr, ves_states, fused_ves] = main_exocytosis_stoch(Ca_time_vesicles, Ca_R_vesicles, par, stim_freq);
