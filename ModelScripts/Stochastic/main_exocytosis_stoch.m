function [peak1, peak2, time_vector, stoch_EPSC, ppr, peaksum, ttp2080, peak2_extr, ppr_extr, pVr1, stoch_time, act_states_summed, fast_states, slow_states, total_fast_states, total_slow_states, peaksum_extr, ves_states, fused_ves] = main_exocytosis_stoch(Ca_time_vesicles, Ca_R_vesicles, par, stim_freq)
%%%%%%%%%%%%%%%
...
if unprim_onestate
    ...
    [Caprim_rate, Caunprim_rate] = calculate_Caprim_rate(Ca_bas, Ca_prim_type, prim_kM, prim_rate_const, unprim_rate_const, unprim_rate_const_0, unprim_mutant);
